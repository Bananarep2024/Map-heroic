...
| **J4 — 90 zones** | 3 j | `Zones.cs` (germes par bassin, croissance à clé recalculée, équilibrage mou, compacité, articulations) | 200 seeds : 100 % à 90 zones connexes, 100 % dans ± 30 %, ≥ 95 % dans ± 25 % ; 0 articulation isolant < 3 zones ; < 50 ms |
